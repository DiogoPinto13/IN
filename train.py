    ...
    for i, question in enumerate(questions_list):
        ...
        for model in question["models_list"]:
            for seed in range(15):
                labels_stratify = None if i == 0 else labels 
                X_train, X_test, y_train, y_test = train_test_split(df, labels, test_size=0.3, random_state=seed, stratify=labels_stratify)
